...
public class OpenAPIConfig {
    ...
    @Value("${casado.openapi.dev-url}")
    private String devUrl;

    @Value("${casado.openapi.prod-url}")
    ...
    public OpenAPI myOpenAPI() {
        ...
        contact.setEmail("acasado666@gmail.com");
        contact.setName("Antonio Casado");
        contact.setUrl("https://www.antonio-casado.com");
